...
class GenerateReport:
    ...
    def get_best_item(self):
        try:
            ...
            print(e)
            print("A problem occured while sorting the items")
            return None
...
class AmazonAPI:
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                availablity = self.driver.find_element_by_id('availablity').tetx
